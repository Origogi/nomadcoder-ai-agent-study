...
class Quiz(BaseModel):
    topic: str = Field(
        description="The main topic being tested",
    )
    questions: List[Question] = Field(description="List of the questions")
...
def generate_quiz(
    ...
    Make sure to use the reasearch information to create the most accurate questions.
    """
