...
async def create_message(conversation_id : str, message_input : CreateMessageInput):
...
async def create_message_stream(conversation_id : str, message_input : CreateMessageInput):
...
async def create_message_stream_all(conversation_id : str, message_input : CreateMessageInput):
    async def event_generator():
        events = Runner.run_streamed(
            starting_agent=agent,
            input=message_input.question,
